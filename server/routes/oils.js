...
const { getAllOils, getOneOilByName, getOilBySymptom, getOilByTheme, getOilByDiffusion, createOil, updateOil, searchOilByKeyword } = require('../controllers/oilsController');
